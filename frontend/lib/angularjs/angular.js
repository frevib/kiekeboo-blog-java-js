    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           * @module ng
           * @param {string} name service name
           * @param {*} object services instance object.
           * @description
 ...
 * service.
 *
 * services provider names start with the name of the service they provide followed by `Provider`.
 * For example, the {@link ng.$log $log} service has a provider called
 * {@link ng.$logProvider $logProvider}.
 *
 * services provider objects can have additional methods which allow configuration of the provider
